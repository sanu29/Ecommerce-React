...
export const ProfileSideBar = () => {
    ...
    return( <div className="profile-sidebar ">
        ...
        <NavLink to={"/address"} style={({ isActive }) => isActive ? activeStyle : undefined}  className="option menu-option">Address</NavLink>
        <NavLink to={"/order"} style={({ isActive }) => isActive ? activeStyle : undefined}  className="option menu-option">Orders</NavLink>
    </div>);
};
